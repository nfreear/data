...
module.exports = {
  ...
  BBC_SOUNDS_BOOKMARKS_I : require('./data/bbc-sounds-bookmarks-offset-0-limit-100'),
  BBC_SOUNDS_BOOKMARKS_II: require('./data/bbc-sounds-bookmarks-offset-99-limit-100'),
